...
2.  **Running Locally:** You can also run the project on your own machine. The repository is organized into two main components:
    *   **`streamlit app/` — Streamlit App:** A user-friendly graphical interface for generating plots without code. If you want to run the visual app on your computer, follow the instructions in the [**Streamlit App README**](./streamlit app/README.md).
